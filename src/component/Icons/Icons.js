...
export const DeleteSearchIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const LoadingSearchIcon = ({ className, width = '1.6rem', height = '1.6rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const LiveIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const FavoritesIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
...
export const GetCoinsIcon = ({ className, width = '2rem', height = '2rem' }) => (
    <svg
        className={className}
        width={width}
        data-e2e=""
